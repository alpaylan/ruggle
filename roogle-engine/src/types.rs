...
#[non_exhaustive]
#[derive(
    Clone, Debug, Serialize, Deserialize, PartialEq, Eq, Hash, bincode::Encode, bincode::Decode,
)]
#[serde(rename_all = "snake_case")]
pub enum Qualifiers {
    Const,
...
#[derive(
    Clone, Debug, Default, Serialize, Deserialize, PartialEq, bincode::Encode, bincode::Decode,
)]
pub struct Generics {
